...
const terms = [
  ...
  "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Vijayanagar, Bengaluru, Karnataka.",
        ...
        <div className="max-w-3xl space-y-10 scroll-reveal scroll-reveal-delay-1">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              binding agreement by and between <strong className="text-foreground">BRANDEXLABS</strong>{" "}
